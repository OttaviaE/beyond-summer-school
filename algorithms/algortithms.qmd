...
Tutto molto bello, tutti molto simpatici ma questi algoritmi nonm tengono in considerazion l'unica ragione per cui esistono, ovvero la stanchezza dovuta alla lunghezza della somministrazione

All'andare avanti della somministrazione, comincia ad esserci la stanchezza e le risposte delle persone potrebbero risentirne in termini di accuratezza 

## Response Fatigue

Response fatigue: Lower the upper asymptote as described by $d$: 
